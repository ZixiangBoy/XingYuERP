namespace Ultra.Surface.Form
{
    partial class MainSurface
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.baseBarMgr = new DevExpress.XtraBars.BarManager();
            ...
            this.baseBarMgr.Images = this.imageList1;
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnEdt, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnRefresh, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnLock, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnUnLock, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnInvalid, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnDel, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnPrint, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnRole, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnRoleUsr, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnImport, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnExport, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnAudit, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnRefuse, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnSubmit, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnUnAudit, true),
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnGet, true),
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnSync, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnBatchUpdate),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnEnable, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnDisable, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barBtnRestore, true)});
            ...
            // barBtnExport
            // 
            this.barBtnExport.Caption = "导出(&E)";
            ...
            this.barDockControlTop.Size = new System.Drawing.Size(1348, 69);
            // 
            ...
            this.barDockControlRight.Location = new System.Drawing.Point(1348, 69);
