    ...
    public partial class MainView : BaseForm, Ultra.Surface.Interfaces.ISurfacePermission
    {
        ...
        public List<Ultra.Surface.Interfaces.PermitGridView> Grids {
            get {
                ...
                new Ultra.Surface.Interfaces.PermitGridView(this.gridView1,"积分变动记录")
            };
            }
        }
        ...
        private void MainView_Load(object sender, EventArgs e)
        {
            ...
            myBar.btnExport.ItemClick += barBtnExport_pointfeelogClick;
        }

        void barBtnExport_pointfeelogClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
        ...
        void barBtnRefresh_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.gridControlEx1.DataSource = db.Fetch<t_pointfeelog>("select * from t_pointfeelog order by id desc");
            }
        }
    }
}
